  ...
  return (
    <div>
      ...
      >
        ...
        <form>
          <Modal.Body height="800px" scroll={true}>
            <Grid.Container gap={2}>
              ...
              <Grid xs={12} lg={12} md={12} sm={12} xl={12}>
                <Text size={15}>Name: {props.data.name}</Text>
              </Grid>
              <Grid xs={12} lg={12} md={12} sm={12} xl={12}>
                <Text size={15}>Email: {props.data.email}</Text>
              </Grid>
              <Grid xs={12} lg={12} md={12} sm={12} xl={12}>
                <Text size={15}>No of people: {props.data.people}</Text>
              </Grid>
              ...
              <Grid xs={12} lg={12} md={12} sm={12} xl={12}>
                <Text b size={15}>
                  Own Vehicle : {props.data.ownVehicle ? "Yes" : "No"}
                </Text>
              </Grid>
            </Grid.Container>
          </Modal.Body>
