...
export default function LandmarkDelete(props) {
    ...
    const handleDelete = () => {
        ...
        // delete the room
        deleteData(`Hotels/${props.hotelId}/Landmarks/${props.data.id}`).then(() => {
            // u[date the query cache
            queryClient.setQueryData(["hotels", props.hotelId, "landmarks"], (oldData) => {
                return {
                    ...oldData,
