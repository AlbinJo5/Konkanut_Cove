...
export default function ActivityDelete(props) {
    ...
    const handleDelete = () => {
        ...
        // delete the room
        deleteData(`Packages/${props.packageId}/Activities/${props.packageActivityId.id}`).then(() => {
            ...
            queryClient.setQueryData([
                ...
                return {
                    ...oldData,
                    data: oldData.data.filter((room) => room.id !== props.packageActivityId.id)

                }
            }
            );
            alert("Activity deleted");
            props.activityContentChange();
            setLoading(false);
        }
        ).catch((error) => {
            console.log(error);
