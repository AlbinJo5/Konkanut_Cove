...
export const Cancellations = ({until,after,refund1="100%",refund2="No"})=>{
  ...
  return(
    <div className="flex flex-col">
      ...
      <div className="flex">
        <div className="bg-red-400 w-2 h-full mr-4"></div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col border-[1px] border-gray-200 shadow-2xl py-5 rounded-lg px-10">
          ...
          <div className="grid grid-rows-2 grid-flow-col gap-4 w-full h-[250px]">
            ...
            <div className="flex items-start mt-4">
              ...
              <button className="bg-green-800 text-white px-5 py-2 rounded-md hover:transition-transform hover:scale-110 hover:duration-750">Send Enquiry</button>
            </div>
            <div className="flex mt-4 grow">
                <Landmarks landmarks={landmarks}/>
                <div className="flex flex-col ml-12 grow">
