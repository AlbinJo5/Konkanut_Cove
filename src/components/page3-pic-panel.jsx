    ...
    return (
        <div className="flex flex-col w-full border-[1px] border-gray-200 shadow-2xl px-5 rounded-md bg-repeat mx-2" style={{
            ...
            <div className="grid grid-rows-2 grid-flow-col gap-4 w-full h-[400px] px-10">
                <div className="row-span-2 relative"><Image src={image6} alt="grid pictures" fill className="rounded-md"/></div>
                <div className="col-span-2 relative"><Image src={image2} alt="grid pictures" fill className="rounded-md"/></div>
                <div className="row-span-1 relative"><Image src={image1} alt="grid pictures" fill className="rounded-md"/></div>
                <div className="row-span-1 relative"><Image src={image3} alt="grid pictures" fill className="rounded-md"/></div>
                <div className="col-span-1 relative"><Image src={image4} alt="grid pictures" fill className="rounded-md"/></div>
