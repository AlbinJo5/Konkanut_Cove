    ...
    return(
        <div className="flex flex-col bg-repeat" style={{
            ...
            <div className="flex items-center mt-2">
                ...
                <button className="rounded-md w-10 hover:w-12 transition-transform delay-750 active:rotate-180" onClick={handleClick}
                onTransitionEnd={handleIconTransition} >
                    <AccIcon size="inherit" className="fill-current text-slate-600" />
                </button>
            </div>

            <div className={clsx("transition-transform delay-200 origin-top",{"scale-0":collapse})} onTransitionEnd={handleTransitionEnd}>
                ...
                <div className="text-2xl font-bold my-3 px-8 max-md:px-5 text-green-800">{title2}</div>
