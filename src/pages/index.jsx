...
function FormModal({showModal,setShowModal}){
  ...
  return(
      <div className="fixed z-50 inset-0 flex justify-center items-center px-1 bg-black bg-opacity-25 md:hidden" onClick={closeModal}>
...
export default function Home({mainTitle,mainText,widthText,widthTitle,sections}) {
    ...
    <Layout>
      <Head>
        ...
        <div className="w-full relative h-[850vh] sm:h-[550vh]">
          <div className="w-full min-w-[100vh] h-[850vh] sm:h-[550vh] absolute z-0 bg-cover" style={{backgroundImage:"url('/assets/images/background.png')"}}></div>
          <div className="w-full min-w-[100vh] h-[850vh] sm:h-[550vh] absolute z-10 bg-black bg-opacity-10">
            ...
            <div className="flex justify-center mb-10">
              <div className="md:w-[900px] px-3 w-full">
                <SearchBar/>
              </div>
            </div>
        ...
        <div className="relative">
          ...
          <div className="absolute z-40 top-[70%] sm:hidden flex justify-center w-full">
            <p className="underline text-green-800 text-md hover:text-green-700 hover:text-sm cursor-pointer" onClick={()=>showModal(true)}> Submit feedback form</p>
          </div>
        </div>
...
export async function getStaticProps(){
  return {
    props:{
      mainTitle: "Spend Quality Holidays <span key={2} style='color:#22543d;'> With Us.</span>",
      ...
      sections:[
...

        {
          desc:{
            ...
            maxWidth:"350px",
            paragraphs:["Sindhudurg is the First Tourism District declared in Maharashtra in the year 1997. Sindhudurg has a 121-kilometer-long coastline.",
            "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,.Lorem Ipsum is "
            ],
            alignLeft:false,
          },
        ...
        
        {
          desc:{
            heading:"Places ",
            maxWidth:"350px",
            paragraphs:["We give you more of what you want and less of what you don’t Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standarddummy text ever since the 1500s.",
