                  ...
                  <MainHeader>
                    ...
                    <div className="flex max-xs:flex-col text-white justify-center w-full">
                        <div className="flex flex-col items-center justify-center mt-5 sm:mr-40 mr-20 max-xs:mr-0">
                            ...
                            <Link rel="stylesheet" href={"mailto:"+email} className="bg-green-800 font-bold px-5 py-4 rounded-md" >{email}</Link>
                        </div>
                        <div className="flex flex-col items-center mt-5">
                            <p className="text-lg mb-3">Phone</p>
                            <Link rel="stylesheet" href={"tel:"+phone} className="bg-green-800 font-bold px-5 py-4 rounded-md" >{email}</Link>
                        </div>
                    </div>
              </div>
              </div>
