    ...
    <Layout>
      <Fade top>
        <div
          ...
          style={{ backgroundImage: "url('/assets/images/back33.png')" }}
        >
          ...
          <div className="pt-52 pb-36 w-full bg-black bg-opacity-20">
            <MainHeader>
              <MainTitle width="600px">{title}</MainTitle>
      ...
      >
        {datas.map((d, i) => (
          <li className="mb-28 max-w-[600px] md:w-[700px] lg:w-[600px]" key={i}>
            <Fade bottom>
              <Page2Panel {...d} width={300} height={150} top="-50px" key={i} />
            </Fade>
          </li>
        ))}
      </ul>
