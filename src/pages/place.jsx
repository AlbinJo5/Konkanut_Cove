...
export default function Place({data}) {
    return (
      <Layout>
          <div className="bg-cover h-80" style={{backgroundImage:"url('/assets/images/back22.png')"}}>
           ...
           <ul className="bg-repeat" style={{backgroundImage:"url('/assets/images/back3.png')"}}>
              {data.map((d,i)=>
